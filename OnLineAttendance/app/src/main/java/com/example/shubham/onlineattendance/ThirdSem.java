...
public class ThirdSem extends AppCompatActivity{
    ...
    private String URL_Students = "http://192.168.43.149/getPresents.php";
    private BluetoothAdapter bluetoothAdapter;
    private static final int ENABLE_BT_REQUEST_CODE = 1112;
    Button present;
    ListView lv;
    TextView Roll,fname,lname;
    CheckBox check;
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ThirdSem.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
                    }
                });
    ...
    private void showJSON(String response, String Address) {
        ...
        try {
            ...
            for (int i= 0;i<=result.length();i++) {
               ...
               s=new Spacecraft();
                Toast.makeText(this, ""+baddress, Toast.LENGTH_SHORT).show();
