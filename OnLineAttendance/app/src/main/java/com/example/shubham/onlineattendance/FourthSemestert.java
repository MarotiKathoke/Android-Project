...
public class FourthSemestert extends AppCompatActivity {
    private String URL_Students = "http://192.168.43.149/StudentsList/FourthSem/getFixture.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fourth_semestert);
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(FourthSemestert.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
                    }
                });
