...
public class SubjectFifth extends AppCompatActivity implements View.OnClickListener {
    ...
    String et_sub;
    EditText sub;
    private static final String REGISTER_URL = "http://192.168.43.149/ChooseSubject/spinner/fifth/CatAss.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_subject_fifth);
        ...
        ivUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String Text = spinnerSubj.getSelectedItem().toString();
                Intent intent = new Intent(SubjectFifth.this, FifthSemester.class);
    ...
    private void register(String sname) {
        class RegisterUser extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(SubjectFifth.this, "Please Wait", null, true, true);
            }
    ...
    protected void onStart() {
        super.onStart();
        SubjectFifth.BackTask bt = new SubjectFifth.BackTask();
        bt.execute();
    }
    ...
    private class BackTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                HttpPost httpPost = new HttpPost("http://192.168.43.149:80/ChooseSubject/spinner/fifth/get_categories.php");
