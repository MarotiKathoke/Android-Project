...
public class RegisterTeacher extends AppCompatActivity implements View.OnClickListener {
    private EditText et_fname, et_mname, et_lname, et_phone, et_address, et_email,et_password, et_cpassword;
    Button Register;

    private static final String REGISTER_URL = "http://192.168.43.149/TeacherRegistration.php";
    private String fname, mname, lname, phonno, address, emails,passwors, cpassword;
    @Override
    ...
    public void registeru()
    {
        ...
        else
        {
            ...
            if(mBluetoothAdapter==null)
            {
                ...
                register(fname, mname, lname, emails, phonno, address, passwors, macAddress);
            }
        }
    }
    ...
    private void register(String fname,String mname, String lname, String emails, String phonno, String address, String passwors,String macAddress) {
        class RegisterUser extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(RegisterTeacher.this, "Please Wait",null, true, true);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                {
                    Intent in = new Intent(getApplicationContext(), TeacherView.class);
                    startActivity(in);
