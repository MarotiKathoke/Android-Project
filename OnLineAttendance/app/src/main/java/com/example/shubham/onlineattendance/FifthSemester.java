...
public class FifthSemester extends AppCompatActivity {
    private String URL_Students = "http://192.168.43.149/StudentsList/FifthSem/getFixture.php";
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(FifthSemester.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
                    }
                });
