...
public class SubjectEiegth extends AppCompatActivity implements View.OnClickListener{
    ...
    String et_sub;
    EditText sub;
    private static final String REGISTER_URL = "http://192.168.43.149/ChooseSubject/spinner/eiegth/CatAss.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.subject_eiegth);
        ...
        ivUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SubjectEiegth.this, EightSemester.class);
    ...
    private void register(String sname) {
        class RegisterUser extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(SubjectEiegth.this, "Please Wait", null, true, true);
            }
    ...
    protected void onStart() {
        super.onStart();
        SubjectEiegth.BackTask bt = new SubjectEiegth.BackTask();
        bt.execute();
    }
    ...
    private class BackTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                HttpPost httpPost = new HttpPost("http://192.168.43.149:80/ChooseSubject/spinner/eiegth/get_categories.php");
