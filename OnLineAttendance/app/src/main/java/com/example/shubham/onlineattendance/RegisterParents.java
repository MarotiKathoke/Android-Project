...
public class RegisterParents extends AppCompatActivity  implements View.OnClickListener{
    private EditText et_fname, et_mname, et_lname, et_phone,et_sonphone, et_email,et_password, et_cpassword;
    Button Register;
    RadioButton student, teacher, parent;
    RadioGroup option;
    private static final String REGISTER_URL = "http://192.168.43.149/ParentsRegister.php";
    private String fname, mname, lname, phonno,sphone, emails,passwors, cpassword;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_sonphone = (EditText) findViewById(R.id.sphone);
    ...
    public void registeru()
    {
        ...
        else
        {
            ...
            if(mBluetoothAdapter==null)
            {
                ...
                register(fname, mname, lname, emails, phonno, sphone, passwors,macAddress);
            }
        }
    }
    ...
    public boolean validate()
    {
        ...
        if(sphone.isEmpty()||sphone.length()<10||sphone.length()>10)
        {
            et_sonphone.setError("Please Enter minimum 10 digits");
            valid = false;
        }
        ...
        {
            et_cpassword.setError("password not macth");
            valid = false;
        }
        return valid;
    }
    public void  initialize()
    {
        ...
        phonno = et_phone.getText().toString().trim().toLowerCase();
        sphone = et_sonphone.getText().toString().trim().toLowerCase();
    ...
    private void register(String fname,String mname, String lname, String emails, String phonno, String address, String passwors,String macAddress) {
        class RegisterUser extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(RegisterParents.this, "Please Wait",null, true, true);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                {
                    Intent in = new Intent(getApplicationContext(), ParentView.class);
                    startActivity(in);
            ...
            protected String doInBackground(String... params) {
                ...
                data.put("sphone",params[5]);
                data.put("passwors",params[6]);
                data.put("macAddress",params[7]);
        ...
        ru.execute(fname,mname,lname,emails,phonno,address,passwors,macAddress);
    }
}
